...
(* OASIS_START *)
(* DO NOT EDIT (digest: 49e67d821317201110009942863476b4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Jeu de type sokoban, avec exploitation d'oasis.";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("tsdl", None);
                           InternalLibrary "simplist";
                      ...
                      bs_data_files =
                        [
                           ("../data/textures/*.png",
                             Some "$datadir/$pkg_name/textures");
                           ("../data/sons/*.ogg",
                             Some "$datadir/$pkg_name/sons");
                           ("../data/niveaux/*.simplist",
                             Some "$datadir/$pkg_name/niveaux")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\0174\012Z\021\234F&=\229\r\236\0248\176\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
